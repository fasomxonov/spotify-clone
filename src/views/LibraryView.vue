...
<template>
  <div class="p-8">
    ...
    <div class="flex items-center w-full relative h-full">
      <img width="140" height="140" src="../../public/DiariesOfAHero.png" alt="img-albumCover">
      <div class="w-full ml-5">
        <div class="text-[33px] text-white absolute hover:underline cursor-pointer top-0 font-semibold">{{ artist.name }}</div>
        ...
        <div class="absolute flex gap-4 items-center justify-start bottom-0 mb-1.5">
          <button class="p-1 rounded-full bg-white" type="button" @click="playFunc()">
            <Play v-if="!isPlaying" fillColor="#181818" :size="25" />
            <Pause v-else fillColor="#181818" :size="25" />
          </button>
          <button type="button">
            <Heart fillColor="#1DB760" :size="30" />
          </button>
          <button type="button">
